...
const AdminDashboard = () => {
  ...
  const fetchMembers = async () => {
    const res = await axios.get(
      "https://gym-management-system-4vg8.onrender.com/api/members"
    );
    setMembers(res.data);
  };
  ...
  const fetchMemberUsers = async () => {
    const res = await axios.get(
      "https://gym-management-system-4vg8.onrender.com/api/users"
    );
  ...
  const fetchBills = async () => {
    const res = await axios.get(
      "https://gym-management-system-4vg8.onrender.com/api/bills"
    );
    setBills(res.data);
  };
  ...
  const fetchNotifications = async () => {
    const res = await axios.get(
      "https://gym-management-system-4vg8.onrender.com/api/notifications"
    );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingId) {
        await axios.put(
          `https://gym-management-system-4vg8.onrender.com/api/members/${editingId}`,
          form
        );
      } else {
        await axios.post(
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Delete this member?")) {
      await axios.delete(
        `https://gym-management-system-4vg8.onrender.com/api/members/${id}`
      );
      fetchMembers();
    }
  };
