...
const MemberDashboard = () => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://gym-management-system-4vg8.onrender.com/api/bills/member/${member._id}`
      )
  ...
  useEffect(() => {
    axios
      .get("https://gym-management-system-4vg8.onrender.com/api/notifications")
      .then((res) => setNotifications(res.data));
  }, []);

  const handlePay = async (id) => {
    await axios.put(
      `https://gym-management-system-4vg8.onrender.com/api/bills/${id}/pay`
    );
    // Refresh bills
